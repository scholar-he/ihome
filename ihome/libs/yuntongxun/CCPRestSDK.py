...
class REST:
    ...
    def subAuth(self):
        ...
        elif self.ServerPort<=0:
            print('172005')
            print('端口错误（小于等于0）')
        
        elif self.SoftVersion=="":
            print('172013')
            print('版本号为空')
        
        elif self.SubAccountSid=="":
            print('172008')
            print('子帐号为空')
        
        elif self.SubAccountToken=="":
            print('172009')
            print('子帐号令牌为空')
    ...
    def accAuth(self):
        ...
        elif self.AccountSid=="":
            print('172006')
            print('主帐号为空')
        
        elif self.AccountToken=="":
            print('172007')
            print('主帐号令牌为空')
